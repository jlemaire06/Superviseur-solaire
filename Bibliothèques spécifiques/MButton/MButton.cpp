...
{ 
    ...
    switch (num)
    {
      ...
      case 12:
        ...
        break;
      case 14:
        attachInterrupt(14, buttonInterrupt14, CHANGE);
        break;
      case 27:
        attachInterrupt(27, buttonInterrupt27, CHANGE);
        break;
...
void IRAM_ATTR MButton::buttonInterrupt14()
{
 if (_okButton && !_toProcess)  
  {
    _num = 14;
...
void IRAM_ATTR MButton::buttonInterrupt27()
{
 if (_okButton && !_toProcess)  
  {
    _num = 27;
